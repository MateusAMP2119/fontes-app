/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.auth.jsonc --env-interface=AuthBindings worker-configuration-auth.d.ts` (hash: b7c0b98f6302cdc4a63f422849751b74)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/auth");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_SUPABASE_URL" | "VITE_SUPABASE_PUBLISHABLE_KEY" | "VITE_API_URL">> {}
}
