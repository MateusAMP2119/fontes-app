...
export type Draft = { step: Step; returning: boolean; provider: 'email' | 'google'; email: string; name: string; slug: string; profile: string; invitations: string; changelog: boolean; daily: boolean }
...
const fresh: Draft = { step: 'start', returning: false, provider: 'email', email: '', name: '', slug: '', profile: '', invitations: '', changelog: false, daily: false }
